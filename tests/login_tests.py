...
class TestLogin(LoginPage):
    ...
    def test_login_incorrect_credentials(self):
        ...
        self.compare_UI_with_reference(self.LOGIN_ERROR_MESSAGE, in_app_login_error_message, fail_message_login_incorrect_credentials)
    ...
    def test_login_correct_credentials(self):
        ...
        self.compare_UI_with_reference(self.HOME_PAGE_TITLE, self.get_home_page_title(), fail_message_login_correct_credentials)
