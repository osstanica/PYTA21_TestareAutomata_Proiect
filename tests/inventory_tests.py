...
class TestInventory(InventoryPage, LoginPage):
    ...
    def test_az_default_sorting(self):
        ...
        self.compare_UI_with_reference(self.DEFAULT_SORTING_OPTION, in_app_sorting_option, fail_message_sorting_default_option)
        ...
        self.compare_UI_with_reference(sorted(list_all_item_names), list_all_item_names, fail_message_elements_az_sorting)
    ...
    def test_other_sorting(self):
        ...
        if in_app_sorting_option == self.ZA_SORTING_OPTION:
            ...
            self.compare_UI_with_reference(list_all_item_names, list_all_item_names_UI, fail_message_elements_za_sorting)
            ...
            self.compare_UI_with_reference(list_all_item_prices, list_all_item_prices_UI, fail_message_elements_lohi_sorting)
            ...
            self.compare_UI_with_reference(list_all_item_prices, list_all_item_prices_UI, fail_message_elements_hilo_sorting)
    ...
    def test_product_added_to_cart(self):
        ...
        self.compare_UI_with_reference("Remove", self.driver.find_element(By.XPATH, f"({self.ADD_PRODUCT_TO_CART_LOCATOR_By_XPATH})[{inventory_item}]").text, fail_message_remove_button_displayed)

        fail_message_cart_icon_update = "The cart icon should display a label of 1!"
        self.compare_UI_with_reference(True, self.get_cart_icon_label(1), fail_message_cart_icon_update)
